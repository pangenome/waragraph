...
mod tests {
    ...
    fn fill_from_slice_to_fit() -> Result<()> {
        ...
        let row_map = |row: &usize| -> Option<RowEntry<String>> {
            Some(RowEntry {
                grid_template_columns: vec![fr(1.0)],
    ...
    fn row_grid_layout() -> Result<()> {
        ...
        let expected_results = [
            (15, [200.0, 380.0], [700.0, 0.0]),
            (14, [100.0, 380.0], [100.0, 0.0]),
            (13, [200.0, 320.0], [700.0, 60.0]),
            (12, [100.0, 320.0], [100.0, 60.0]),
            (11, [200.0, 320.0], [700.0, 0.0]),
            (10, [100.0, 320.0], [100.0, 0.0]),
            (9, [200.0, 270.0], [700.0, 50.0]),
            (8, [100.0, 270.0], [100.0, 50.0]),
            (7, [200.0, 270.0], [700.0, 0.0]),
            (6, [100.0, 270.0], [100.0, 0.0]),
            (5, [200.0, 230.0], [700.0, 40.0]),
            (4, [100.0, 230.0], [100.0, 40.0]),
            (3, [200.0, 230.0], [700.0, 0.0]),
            (2, [100.0, 230.0], [100.0, 0.0]),
